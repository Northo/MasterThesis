...
A schematic summary of all the contributions are given in \cref{fig:schematic_tz}.


\begin{figure*}[p]
\subfloat[Type-I]{
    \includegraphics[width=.3\textwidth]{figures/divergentContribCutoff}
}
\subfloat[Type-II inter band]{
    \includegraphics[width=.3\textwidth]{figures/tzcontribtypeii}
}
\subfloat[Type-II intraband]{
    \includegraphics[width=.3\textwidth]{figures/tzcontribtypeii_intraband}
}
