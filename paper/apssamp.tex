...
\subcaptionbox{Type-I}{
    \includegraphics[width=.3\columnwidth]{figures/divergentContribCutoff}
}
\subcaptionbox{Type-II inter band}{
    \includegraphics[width=.3\columnwidth]{figures/tzcontribtypeii}
}
\subcaptionbox{Type-II intraband}{
    \includegraphics[width=.3\columnwidth]{figures/tzcontribtypeii_intraband}
}
\end{figure}
