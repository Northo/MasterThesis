...
The repsonse dependes on the symmetries of the tilt
- parallel inversion broken tilt, no change of the effect in type i.
  At type ii, collapse
- parallel inverion symmetric tilt, extra contribution proportional to titl, positive for tilt in the same direction of the magnetic field
  Dependent on some momentum cutoff
  At type ii, drastic artifact, then diminish
- perp tilt, gradually diminish
  possible to have more exciting response, but must be made more
...
* TODOS [18/25]
** DONE Summary
- To include the introductory sentence or to not include the introductory sentence, that is the question.
** DONE Introduction
- Is it clear what we set out to do?
** DONE Intro ch. 4
** TODO Cutoff
- The untitled integral converges very quickly in kappa, so the cutoff does not affect it much
** TODO Results
- Comment on the cutoff in any way?
** TODO Conclusion
- Do we answer what we set out to find?
** TODO Spell check everything
Also (especially) the old sections
** DONE Align fig 1.7 with text
** DONE Placement of figs in results
** TODO Side by side or above fig 1.8?
** DONE Clean up repetition around 4.5 (type-I)
** DONE Cleanup around 4.197 4.198 wrt fig reference
** TODO Check if anything needs cite
-
-
-
** DONE Bibliography
*** DONE Formatting
*** DONE Check sources (i.e. actual journal, not arxiv etc.)

** DONE Sorting in multicite
...
** DONE Consistent colors in results for plots
