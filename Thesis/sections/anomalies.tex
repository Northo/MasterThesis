...
The calculation also has some historical importance, as the problem we will solve is in fact exactly the same as the problem that led to the discovery of anomalies~\cite{adlerAxialVectorVertexSpinor1969,bellPCACPuzzleP01969}!%
