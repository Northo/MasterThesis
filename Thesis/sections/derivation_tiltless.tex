...
\end{equation}
As is shown in table \ref{tab:transform-sign}, \( \xi(\kappa_z) \) is invariant under interchagne of \( m,n \) and inversion of \( \kappa_z \).
...
\begin{table}[ht]
  ...
  \end{tabular}
  \caption{Sign change of factors under various transformations. Note that \( \xi(\kappa_z) \) is taken in the limit \( \omega\to0, \eta\to 0 \). \label{tab:transform-sign}}
\end{table}
