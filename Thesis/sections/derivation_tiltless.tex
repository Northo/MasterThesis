...
In order to facilitate for this calculation, we will here evaluate the $y$-integral of the matrix elements in Eqs.~(\ref{eq:11}) and (\ref{eq:12}), which will remove the Hermite polynomials, and then show that all the matrix elements are proportional to linear combinations of some functions $\Xi $ defined below;
