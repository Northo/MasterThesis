...
The sum over $\vec{l}$ in \cref{eq:66} can be replaced by an integration, as it is a good quantum number.
...
The exact same procedure may be done for the stress-energy tensor in \cref{eq:67}.
...
\begin{Proposition}
  ...
  \begin{itemize}
    ...
    \item The difference of the step functions takes the form \cref{eq:92}, which limits the transitions to states with energies of opposite sign.
...
\begin{figure}[ht]
  ...
  \caption{Prefactor \( \gamma_{\bar{N}} \) as a function of the number of inlcuded Landau levels~\( \bar{N} \).}
