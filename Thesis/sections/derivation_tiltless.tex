...
The energy-momentum tensor is used in this work through its conservation law Eq.~\eqref{eq:134}, whose first component gives the conservation of energy.
...
\begin{Proposition}
  We have shown the following simplifications of Eq. \eqref{eq:61}:
  \begin{itemize}
    ...
    \item The difference of the step functions takes the form Eq. \eqref{eq:96}, which limits the transitions to states with energies of opposite sign.
