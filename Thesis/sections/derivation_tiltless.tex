...
\begin{multline}
  \label{eq:114}
\lim_{\vec{q} \to 0} \chi^{xy}(\omega, \vec{q}) =
  -\frac{e v_F \sqrt{2 e B} }{8 (2 \pi)^2}
  \sum\limits_{m n}^{}
  ...
  \frac{
    ...
    (\epsilon_{\kappa_z m s} - \epsilon_{\kappa_z n s} + i \eta)
    (\epsilon_{\kappa_z m s} - \epsilon_{\kappa_z n s} + i \eta + \frac{\omega}{v_{F} \sqrt{2 e B} })
  }.
\end{multline}
