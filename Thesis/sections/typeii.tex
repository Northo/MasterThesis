...
\begin{wrapfigure}[15]{r}{.25\textwidth}
  \centering
  \iftoggle{print}{\vspace{-2.4em}}{\vspace{-2.6em}}
...
% \begin{figure}[!htb]
  ...
  \caption{Two-band tight binding model for a tilted Dirac semimetal.
    ...
    In \subref{fig:typeii:move-nodes} the separation between the two nodes is adjusted.
...
One of the more obvious and common remedies is a momentum cutoff, restricting the model to the region where it is the most correct~\cite{ferreirosAnomalousNernstThermal2017,ferreirosAnomalousNernstThermal2017,sharmaChiralAnomalyLongitudinal2017}.
