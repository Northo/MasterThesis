...
\begin{align}
  ...
  \begin{multlined}[t]
    ...
    % \sum\limits_{i=1}^{4} \chi_{i} (\vec{q}, m, n, s)
    [
    (s-t_x^2) \left[ \alpha _{\vec{k} m s} \Xi_{1} (\vec{q}, m, n, s)
      + \alpha _{\vec{k} + \qvec{q} n s} \Xi _{2} (\vec{q}, m, n, s) \right]\\
      + t_x (1-s) \left[ \alpha _{\vec{k} m s} \alpha _{\vec{k} + \qvec{q} n s} \Xi _1(\vec{q}, m, n\mp 1, s)
      + \Xi _2(\vec{q}, m, n\pm 1, s) \right]
    ],
  \end{multlined}\\
  T_{\vec{k} + \qvec{q} n s, \vec{k} m s}^{0y (1)} (\vec{q}) &=
  \frac{is \alpha}{4  }
