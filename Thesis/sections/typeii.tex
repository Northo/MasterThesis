...
\begin{equation}
  \label{eq:59}
  F^{(3)}_{ij} = \int \mathrm{d} \tilde{y} e^{-\tilde{y}^2} M^{(3)}_{ij}.
\end{equation}
...
\begin{align}
  F^{(3)}_{11} &= \sqrt{\frac{N-1}{2}}
                 ...
                 \frac{\Xi_2( \bar{\vec{q}}, m\mp 1, n\mp 1, s )}{
                 \sqrt{\alpha^2_{\vec{k} m s} + 1}
                 \sqrt{\alpha^2 _{\vec{k} + \qvec{q} n s} + 1}
                 },\\
  F^{(3)}_{22} &= \sqrt{\frac{N}{2}}
                 \frac{1}{l_{B} \alpha _{\vec{k} + \qvec{q} n s}}
                 \frac{\Xi_{2} (\bar{\vec{q}}, m, n, s)}{
                 \sqrt{\alpha _{\vec{k} m s}^2 + 1}
...
\begin{align}
  F^{(3)}_{12} &= -t_x \frac{\alpha _{\vec{k} + \qvec{q} n}}{\alpha _{\vec{k}+\qvec{q} n \mp 1} l_{B}}
                 \sqrt{\frac{N-1}{2}}
                 \frac{\Xi_{2} (\bar{\vec{q}}, m, n \mp 1, s)}{
                 \sqrt{\alpha ^2_{\vec{k} m s} + 1}
                 \sqrt{\alpha ^2_{\vec{k}  + \qvec{q} n} + 1}
                 },\\
  F^{(3)}_{21} &= -\frac{t_x}{l_{B}}
                 \sqrt{\frac{N}{2}}
                 \frac{\alpha_{\vec{k} m}}{\alpha _{\vec{k} + \qvec{q} n}}
                 \frac{\Xi_2 ( \bar{\vec{q}}, m \mp 1, n, s )}{
                 \sqrt{\alpha _{\vec{k} m} ^2 + 1}
                 \sqrt{\alpha _{\vec{k} + \qvec{q} ns} ^2 + 1}
                 }.
\end{align}
