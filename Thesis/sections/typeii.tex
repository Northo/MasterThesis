...
Inserting the current and stress-energy matrix elements we have

\begin{equation}
  \label{eq:65}
  \chi ^{xy~(1,1)} (\omega, \vec{q}) =
  \frac{iv_F eB}{(2\pi)^2}
  \sum\limits_{mn}^{} \int \mathrm{d} \kappa _z
  (n_{\kappa _z m} - n_{\kappa _z n})
  \frac{s v_F e}{\sqrt{\alpha}}
  \frac{is}{4 \sqrt{\alpha } }
  e^{-\frac{l_B^2}{2 \alpha } (q' _x)^2}
  \frac{E_{\kappa _z m} + E_{\kappa _z n}}{
    (\alpha_{\kappa _z m}^2 + 1)(\alpha_{\kappa _z n}^2 + 1)
  }
  (1-t_{x}^2)^{-\frac{1}{2}}\\
  % \sum\limits_{i=1}^{4} \chi_{i} (\vec{q}, m, n, s)
  \Big[
  ...
  \Big]
  (\Xi_1 - \Xi_2)
  \frac{1}{(E_{\kappa _{z} m} - E_{\kappa _{z} n})(E_{\kappa _{z} m} - E_{\kappa _{z} n} + \omega)}.
\end{equation}
