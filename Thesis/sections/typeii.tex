...
\begin{align}
  q' _x &= \frac{q_x + \exists_B - \exists _A}{\alpha }\\
  k' _x &= \frac{k_x + \exists _A}{\alpha }
\end{align}
where
\[
  \exists _A = \frac{\beta}{l_{B} \sqrt{\alpha }} \sign(m) \sqrt{\frac{k_{z}^2l_{B}^2}{\alpha } + 2 M}, \quad
  \exists _B = \frac{\beta}{l_{B} \sqrt{\alpha }} \sign(n) \sqrt{\frac{k_{z}^2l_{B}^2}{\alpha } + 2 N}
\]
\begin{align}
