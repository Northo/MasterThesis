...
As \( k_0 \) is reduced, the cones are brought closer together and made anisotropic, as the effective Fermi velocity is not the same in the \( x \) and \( y \) direction, as shown in \cref{fig:typeii:move-nodes}, where two cones are moved unitl they meet at the origin.
...
\begin{figure}[h]
  ...
  \caption{Time reversal breaking in tilted system.
    ...
    \todo{Must be referred to in text. Related to the spin structure of the cone}
  }
\end{figure}
