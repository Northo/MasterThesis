...
The standard model for metals in condensed matter physics is the Landau Fermi liquid~\cite{landauTheoryFermiLiquid1956,chernodubThermalTransportGeometry2021}, where electrons are described by the Hamiltonian \( p^2 /2 m^* \), with \( m^* \) some effective mass.
...
The notion of a ``Dirac fermion'' is almost comical from a high energy point of view~\cite{chernodubThermalTransportGeometry2021,vozmedianoTheoreticalPhysicsColloquium2021} -- what else can they be?
...
\begin{figure}[p!]
  ...
  \iftoggle{full-size-image}{%
    \includegraphics[width=\textwidth]{figures/cones-types-finish}
  }{%
    \includegraphics[width=\textwidth]{figures/cones-types-finish-small}
  }
  \caption{%
...
\begin{figure}[p!]
  ...
  \iftoggle{full-size-image}{%
    \includegraphics[width=\textwidth]{figures/cones-tilt-finish}
  }{%
    \includegraphics[width=\textwidth]{figures/cones-tilt-finish-small}
  }
