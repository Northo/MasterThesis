...
\end{equation}
The first term of the energy-momentum tensor thus has the exact same form as the untilted case, however with a prefactor \( \alpha \) and using the transformed coordinates \( \chi \).
We thus get
\begin{multline}
  \label{eq:109}
