...
\begin{figure}[p]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[mark=none] table[col sep=comma, y=-1] {data/contribtypeii.csv};
      \addplot[dashed, mark=none] table[col sep=comma, y=-1] {data/contribtypeii_diffsigntz.csv};
    \end{axis}
  \end{tikzpicture}
  \caption{
    ...
    As explained in the main text, the total contribution for a pair of cones is given by the sum of the even and odd part in inversion symmetric systems, and by the odd part for broken inversion symmetry.
  }
\end{figure}
