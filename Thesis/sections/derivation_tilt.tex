...
On the other hand, for inversion symmetric systems, the contribution from the cone with chirality \( s=-1 \) is the same as that of the \( s=+1 \) cone at the opposite tilt \( t_z \to - t_z \).
...
\todo{Some discussion: we get a positive addition to the prefactor. }
