...
\begin{equation}
  \label{eq:97}
  \gamma_{\text{div}, N} = \frac{1}{2} \sum\limits_{N=0}^{} \int \mathrm{d}\kappa_z \xi(\kappa_z) \kappa_z t^s_z \alpha_{\kappa_z m s}^2 \Big|_{\overset{m=N+1}{n=-N}},
\end{equation}
...
\begin{equation}
  \label{eq:139}
  \gamma_{\text{div}, 0} = -\frac{t_z}{4} \left(\Lambda  \left(\Lambda -\sqrt{\Lambda ^2+1}\right)+\sinh ^{-1}(\Lambda
   )\right)
\end{equation}
