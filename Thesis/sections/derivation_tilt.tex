...
\begin{figure}[htb]
  ...
  \tikzsetnextfilename{divergentContribCutoff}
    ...
    % }
    %
    \caption{The addition of each new Landau level to the divergent factor \( \gamma_{\text{div}, \bar{N}} / t_{z} \) for the first Landau levels, as a function of the momentum cutoff \( \Lambda \).
      Each level has the same \( \Lambda \) dependence;
      they are separated by a \( \Lambda \) independent factor, and the separation decreases for higher levels.
      See main text for details.
