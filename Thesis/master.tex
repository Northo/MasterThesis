...
Some topics discussed are directly applicable to the thesis, while others are included both in order to put the concepts of the thesis in a greater context, and also as it might be useful to know some of them in further continuation of this thesis.
