...
\usepackage{amsfonts}
\usepackage[style=alphabetic, backref=true, safeinputenc, giveninits=true, sortcites=true]{biblatex}
\usepackage{xcolor}
\usepackage{graphicx}
\usepackage{bm}
\usepackage{braket}
...
\usepackage{float}
% \usepackage{letltxmacro}  % https://tex.stackexchange.com/questions/70547/how-can-i-renew-includegraphics-to-always-use-shadowbox
\usepackage{booktabs}
\usepackage{multirow}
...
\setcapindent{2em}  % Make caption slightly hang. See KOMA manual p. 140
...
%% See alternatively sh script
% \usepackage{refcheck}  %% Check for labels with no reference, remove before final version. Should be included late
...
\setlength{\marginwritewidth}{2.8em}
